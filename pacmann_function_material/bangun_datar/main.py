...
if input_user == "lingkaran":
    ...
    print(f"Luas lingkaran adalah {lingkaran.luas_lingkaran(jari_jari)}")
    print(f"Keliling lingkaran adalah {lingkaran.keliling_lingkaran(jari_jari)}")
    ...
    if jenis_persegi_panjang == "luas":
        print(f"Luas persegi panjang adalah {persegi_panjang.luas_persegi_panjang(panjang, lebar)}")
    elif jenis_persegi_panjang == "keliling":        
        print(f"Keliling persegi panjang adalah {persegi_panjang.keliling_persegi_panjang(panjang, lebar)}")
    ...
    if jenis_segitiga == "luas":
        ...
        print(f"Luas segitiga adalah {segitiga.luas_segitiga(alas, tinggi)}")
        ...
        print(f"Keliling segitiga adalah {segitiga.keliling_segitiga(sisi1, sisi2, sisi3)}")
    else:
